"""
Generador de reportes PDF para la aplicación Almas con Cola
Contiene la clase PDFGenerator que genera diferentes tipos de reportes en PDF
"""
...
class PDFGenerator:
    ...
    def generar_reporte_donaciones(self, donaciones):
        ...
        for d in donaciones:
            ...
            tipo = str(d[3]) if len(str(d[3])) <= 20 else str(d[3])
